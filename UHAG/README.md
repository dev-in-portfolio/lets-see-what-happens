...
UHAG is an archive-first gallery app for images that survived in partial, degraded, or uncertain form. It keeps metadata in local JSON, stores originals in Backblaze B2, and fetches private assets through short-lived signed URLs from a thin Node service.
